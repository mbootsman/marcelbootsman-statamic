    ...
    article:
      ...
      -
        ...
        content:
          -
            type: text
            text: 'Now, the site can be easily edited and it all generates static files that can be hosted anywhere with little needed resources.'
    type: article
    enabled: true
seo_noindex: false
seo_nofollow: false
