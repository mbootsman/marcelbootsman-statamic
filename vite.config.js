...
export default defineConfig(({ command, mode }) => {
    ...
    if (useBrowserSync && isSecuredSite) {
        console.log(
            "\x1b[31m%s\x1b[0m",
            "Sorry, we didn't manage to get BrowserSync working with secured sites."
        );
        console.log(
            "\x1b[31m%s\x1b[0m",
            "If you can provide a solution, please enlighten us (https://github.com/studio1902/statamic-peak/pulls)."
        );
        process.exit(1);
    }
